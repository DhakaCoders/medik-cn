...
Constants->>
*/
defined('THEME_NAME') or define('THEME_NAME', 'medik');
...
if( !function_exists('cbv_theme_setup') ){
	...
	function cbv_theme_setup(){
	  ...
	  load_theme_textdomain( 'medik', get_template_directory() . '/languages' );
...
function cbv_theme_scripts(){
  ...
  include_once( THEME_DIR . '/enq-scripts/particles.php' );
	include_once( THEME_DIR . '/enq-scripts/jvectormap.php' );
